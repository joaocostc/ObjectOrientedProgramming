...
public class Pc {
    ...
    public final void setDisco(int disco){
        if(disco % 128 == 0){
            ...
            System.out.println("Disco inválido. Valor 0 para ele.");
            this.disco = 0;
        } 
    }
    ...
    public String toString(){
        return "Marca: " + this.marca + "Modelo: " + this.modelo + "Processador: " + 
                this.processador + "Ram: "+ this.ram + "Disco: " + this.disco;
    }
}